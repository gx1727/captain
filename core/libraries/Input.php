...
class Input
{
    ...
    public function get($key, $default = '', $xss_clean = true)
    {
    ...
    public function post($key, $default = '', $xss_clean = true)
    {
    ...
    public function cookie($key, $default = '', $xss_clean = true)
    {
        $val = $this->_fetch_from_array($_COOKIE, $key, $xss_clean);
        if (!$val) {
            $val = $default;
        }
        return $val;
    ...
    public function xss_clean($str, $is_image = FALSE)
    {
         ...
         *
         * Note:  用 rawurldecode() 对已编码的 URL 字符串进行解码
         * so it does not remove plus signs
         */
