...
<div class="content">
    ...
    <div class="page-user">
        <div class="page-block" style="margin-bottom: 1px;">
            <div class="share" style="margin: 0px;"><p><i class="iconfont" style="font-size: 200%;color:#ff9500;">1</i><span>XXXXXXXXXXXX</span>3243票</p></div>
        </div>
        <div class="page-block" style="margin-bottom: 1px;">
            <div class="share" style="margin: 0px;"><p><i class="iconfont" style="font-size: 200%;color:#ff9500;">2</i><span>XXXXXXXXXXXX</span>3243票</p></div>
        </div>
        <div class="page-block" style="margin-bottom: 1px;">
            <div class="share" style="margin: 0px;"><p><i class="iconfont" style="font-size: 200%;color:#ff9500;">3</i><span>XXXXXXXXXXXX</span>3243票</p></div>
        </div>
        <div class="page-block" style="margin-bottom: 1px;">
            <div class="share" style="margin: 0px;"><p><i class="iconfont" style="font-size: 200%;">4</i><span>XXXXXXXXXXXX</span>3243票</p></div>
        </div>
...
<div class="foot foot1">
    <div class="menu menu1">
        ...
        <a href="/case/rank" class="iconfont icon-hot active">排名</a>
